...
public class BillsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String output = billObj.insertBill(request.getParameter("date"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map paras = getParasMap(request);
			...
			String output = billObj.updateBill(paras.get("hidinvoiceNoSave").toString(), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Map paras = getParasMap(request); 
			 String output = billObj.deleteBill(paras.get("invoiceNo").toString()); 
			response.getWriter().write(output); 
	}
